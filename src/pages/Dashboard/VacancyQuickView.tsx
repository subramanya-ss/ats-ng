  ...
  <Box sx={{ display: 'flex', alignItems: 'flex-start', py: '12px', borderBottom: '1px solid #f3f4f6' }}>
    ...
    <Typography sx={{
      ...
      ...(clamp ? {
        ...
        WebkitLineClamp: clamp, WebkitBoxOrient: 'vertical' as const,
      } : {}),
    }}>
      {value}
    </Typography>
...
const ActionBtn: React.FC<{
  ...
  <Box
    ...
    sx={{
      ...
      gap: '7px', padding: '14px 6px', borderRadius: '12px', cursor: 'pointer',
      fontFamily: 'inherit', backgroundColor: bg, color, border,
      '&:hover': { filter: 'brightness(0.94)' },
      transition: 'filter 0.12s',
    }}
  >
    {icon}
    <Typography sx={{ fontSize: '12px', fontWeight: 600, color: 'inherit', lineHeight: 1 }}>
      {label}
    </Typography>
  </Box>
);
    ...
    >
      ...
      <Box sx={{ px: '20px', py: '16px', borderBottom: '1px solid #f3f4f6', flexShrink: 0 }}>
        <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
          {/* Icon box */}
          <Box sx={{
            width: 56, height: 56, borderRadius: '12px', backgroundColor: '#1a2332',
      ...
      <Box sx={{ px: '20px', pt: '14px', pb: '12px', borderBottom: '1px solid #f3f4f6', flexShrink: 0 }}>
        ...
        <Box sx={{ display: 'flex', gap: '8px' }}>
          <ActionBtn
            icon={<CampaignIcon sx={{ fontSize: '22px', color: '#ffffff' }} />}
            label="Advertise" bg="#16a34a" color="#ffffff" border="none"
          />
          <ActionBtn
            icon={<PauseCircleOutlinedIcon sx={{ fontSize: '22px', color: '#ffffff' }} />}
            label="Suspend" bg="#f59e0b" color="#ffffff" border="none"
          />
          <ActionBtn
          ...
          <ActionBtn
            ...
            label="Remove" bg="#ffffff" color="#ef4444" border="1px solid #fecaca"
          />
        </Box>
      </Box>
      ...
      <Box sx={{ flex: 1, overflowY: 'auto', px: '20px', pb: '32px' }}>
        ...
        {/* Vacancy Details */}
        <SectionHeader icon={<WorkOutlineIcon sx={{ fontSize: '15px', color: '#6b7280' }} />} title="Vacancy Details" />
        ...
        {/* Job Description */}
        <SectionHeader icon={<ArticleOutlinedIcon sx={{ fontSize: '15px', color: '#6b7280' }} />} title="Job Description" />
